...
\newcommand{\DocumentSubtitle}{Homework 3: Face Recognition with Neural Networks}
\newcommand{\ShortTitle}{CI Homework 3} % used in headers (keep short!)
...
\chapter{Homework: Face Recognition with Neural Networks}
...
\section{Neural Networks as Feature Generator}
\input{4}
\clearpage
...
\lstinputlisting[language=matlab]{../implementation/pose.m}
\subsection{Face Recognition}
\lstinputlisting[language=matlab]{../implementation/face.m}

\section{Neural Networks as Feature Generator}
\lstinputlisting[language=matlab]{../implementation/nn_featuregen.m}
