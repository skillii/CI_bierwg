...
\subsection{Script for k-means Algorithm}
\lstinputlisting[language=matlab]{../implementation/hw6_2.m}

\subsection{Function \texttt{k-means}}
\lstinputlisting[language=matlab]{../implementation/k_means.m}
