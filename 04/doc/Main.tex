...
\newcommand{\DocumentSubtitle}{Homework 4: Principal Component Analysis (PCA) and Linear Discriminant Analysis (LDA)}
\newcommand{\ShortTitle}{CI Homework 4} % used in headers (keep short!)
...
\chapter{Homework: Principal Component Analysis (PCA) and Linear Discriminant Analysis (LDA)}
...
\section{PCA}
\lstinputlisting[language=matlab]{../implementation/pca.m}
\section{LDA}
